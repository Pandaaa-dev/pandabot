...
module.exports = {
    ...
    async execute( message, args, text, client){
        ...
        if(!userToAward) return message.channel.send(basicEmbed(client, message, args, text, `You didnt mention anybody!`, `-.-\"`, 'You need to mention somebody for this command to work!'))
        const amount = args[1]
        if(isNaN(amount)){

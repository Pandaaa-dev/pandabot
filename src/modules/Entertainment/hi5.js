...
module.exports = {
    ...
    giflinks: [ 
        ...
        'https://thumbs.gfycat.com/LateAstonishingCowrie-size_restricted.gif'
       
    ],
    async execute( message, args, text, client){
        message.delete()
        if(!message.channel.permissionsFor(message.channel.guild.member(client.user)).has('SEND_MESSAGES')) return
           message.channel.send(entertainmentEmbed(client, message, args, text, `Hi5`, '✋', `${message.author} high-fives ${text}`, this.giflinks))
    }
}
